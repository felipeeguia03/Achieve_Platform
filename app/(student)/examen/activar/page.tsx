 ...
 * `components/superficies/examen-activacion.tsx` porque se dibuja en dos lugares —esta
...
import { VistaDeActivacionDeExamen } from "@/components/superficies/examen-activacion";

export default function ActivarModoExamenPage() {
  return (
    <Shell nodo="UX07">
      <Suspense>
        <VistaDeActivacionDeExamen />
      </Suspense>
    </Shell>
  );
}
