 ...
 * `components/superficies/examen-paso.tsx` porque se dibuja en dos lugares —esta
...
import { VistaDePasoDeProtocolo } from "@/components/superficies/examen-paso";

export default function PasoDeProtocoloPage() {
  return (
    <Shell nodo="UX09">
      <Suspense>
        <VistaDePasoDeProtocolo />
      </Suspense>
    </Shell>
  );
}
