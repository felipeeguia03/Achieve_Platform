...
/**
 * La ruta de FORMACION.
 *
 * ⚠️ **Acá sólo está el marco.** La superficie vive en
 * `components/superficies/formacion.tsx` porque se dibuja en dos lugares —esta
...
import { VistaDeFormacion } from "@/components/superficies/formacion";
