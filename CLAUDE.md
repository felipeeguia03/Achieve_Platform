...
| **El asistente de reportes → Pull Request** | [`asistente-de-reportes.md`](docs/asistente-de-reportes.md) — **es un plan, no está empezado**. Las diez decisiones están cerradas en [ADR-112](docs/decisions.md#adr-112) (`ACCEPTED`, 18 sep): la etapa 1 espera sólo una API key de Anthropic. Estado en su §0.0 |
