...
| **El asistente de reportes → Pull Request** | [`asistente-de-reportes.md`](docs/asistente-de-reportes.md) — **es un plan, no está empezado**. Las decisiones están en [ADR-112](docs/decisions.md#adr-112), `PENDING`: la etapa 1 espera seis de las diez. Estado en su §0.0 |
