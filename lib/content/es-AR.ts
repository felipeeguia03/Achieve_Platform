...
export const copy = {
  ...
  */
  ...
  "MATERIA.COMISION": "Comisión {nombre}",
  "MATERIA.COMISION_DECLARADA": "Comisión {nombre} · la escribiste vos",
  "MATERIA.COMISION_DESCONOCIDA": "Todavía no sabés tu comisión",
  "MATERIA.HORARIO_DESCONOCIDO": "Todavía no sabés tu horario",
  ...
  */
  ...
  "RECORRIDO.TITULO": "Conozcamos tu recorrido académico",
  "RECORRIDO.SUBCOPY":
    "Subí tu analítico para que Achieve reconozca las materias que ya rendiste y te acompañe con más precisión. Es opcional.",
  "RECORRIDO.QUE_EXTRAEMOS": "Qué leemos: materias, estados, notas y fechas de tu analítico.",
  "RECORRIDO.PARA_QUE": "Para qué: entender de dónde venís. No cambia qué materias cursás ahora.",
  "RECORRIDO.REVISAS": "Vos revisás lo que no reconozcamos con seguridad.",
  "RECORRIDO.NO_DIAGNOSTICO": "Una nota no dice cómo sos, y no la usamos para sacar conclusiones sobre vos.",
  "RECORRIDO.PRIVADO": "Es privado: no lo ve tu facultad, ni tu comisión, ni ningún acompañante.",
  "RECORRIDO.PROVISIONAL":
    "Versión de prueba con datos sintéticos: el tratamiento de un analítico real espera la revisión legal.",
  "RECORRIDO.CONSENTIMIENTO": "Acepto que Achieve procese mi analítico para lo que dice arriba.",
  "RECORRIDO.CONSENTIR_CTA": "Aceptar y seguir",
  "RECORRIDO.SIN_ANALITICO": "Todavía no tengo mi analítico",
  "RECORRIDO.SIN_ANALITICO_REGLA": "Podés usar Achieve igual. Lo subís cuando lo tengas.",
  "RECORRIDO.SUBIR_TITULO": "Subí tu analítico",
  "RECORRIDO.SUBIR_AYUDA": "PDF, PNG o JPG, hasta 10 MB y 20 páginas.",
  "RECORRIDO.ELEGIR_ARCHIVO": "Arrastrá el archivo acá o hacé clic para elegirlo",
  "RECORRIDO.SUBIR_CTA": "Subir analítico",
  "RECORRIDO.SUBIENDO": "Leyendo tu analítico…",
  "RECORRIDO.USAR_SINTETICO": "Usar un analítico sintético",
  "RECORRIDO.FALLO.EXTRACCION_NO_DISPONIBLE":
    "Todavía no podemos leer este archivo. Por ahora sólo leemos analíticos de prueba; no guardamos el archivo.",
  "RECORRIDO.FALLO.NO_PARECE_UN_ANALITICO": "Este archivo no parece un analítico. No lo guardamos.",
  "RECORRIDO.FALLO.SIN_RESULTADOS": "No encontramos resultados en este analítico. No lo guardamos.",
  "RECORRIDO.RESUMEN": "Encontramos {resultados} resultados académicos.",
  "RECORRIDO.RESUMEN_DETALLE": "{aprobadas} aprobadas · {regularizadas} regularizadas · {vinculadas} vinculadas con tu plan",
  "RECORRIDO.A_REVISAR": "Necesitamos que revises {n}.",
  "RECORRIDO.SIN_REVISAR": "No quedó nada por revisar.",
  "RECORRIDO.REVISAR_TITULO": "Revisá lo que no reconocimos con seguridad",
  "RECORRIDO.COMO_VINO": "Como figura en tu analítico",
  "RECORRIDO.SIN_NOTA": "sin nota legible",
  "RECORRIDO.ES_LA_MATERIA": "¿Qué materia de tu plan es?",
  "RECORRIDO.ESTADO_ILEGIBLE": "No pudimos leer el estado. ¿Cuál es?",
  "RECORRIDO.CONFIRMAR_FILA": "Confirmar",
  "RECORRIDO.NO_ES_DE_MI_PLAN": "No es de mi plan",
  "RECORRIDO.NO_ESTOY_SEGURO": "No estoy seguro",
  "RECORRIDO.REVISADA.CONFIRMED": "Confirmada",
  "RECORRIDO.REVISADA.CORRECTED": "Corregida",
  "RECORRIDO.REVISADA.UNSURE": "Quedó como «no estoy seguro»",
  "RECORRIDO.REVISADA.NOT_IN_PLAN": "Marcada como fuera de tu plan",
  "RECORRIDO.VER_VINCULADAS": "Ver las {n} que reconocimos",
  "RECORRIDO.CONFIRMAR_CTA": "Confirmar mi recorrido",
  "RECORRIDO.CONFIRMAR_REGLA": "Podés confirmar aunque quede algo sin revisar: queda pendiente, no se completa solo.",
  "RECORRIDO.CONFIRMADO": "Confirmaste tu recorrido.",
  "RECORRIDO.NO_CREA_CURSADAS": "Esto no cambia las materias que cursás ahora: ésas las declaraste en el alta.",
  "RECORRIDO.VERSION_NUEVA": "Subir una versión más nueva",
  "RECORRIDO.ANTERIORES": "Tenés {n} versiones anteriores guardadas.",
  "RECORRIDO.BORRAR": "Borrar mi analítico",
  "RECORRIDO.BORRAR_CONFIRMAR": "¿Borrar tu analítico y lo que salió de él? No se puede deshacer.",
  "RECORRIDO.BORRAR_SI": "Sí, borrar",
  "RECORRIDO.CANCELAR": "Cancelar",
  "RECORRIDO.ESTADO.APPROVED": "Aprobada",
  "RECORRIDO.ESTADO.PROMOTED": "Promocionada",
  "RECORRIDO.ESTADO.REGULARIZED": "Regularizada",
  "RECORRIDO.ESTADO.FAILED": "No aprobada",
  "RECORRIDO.ESTADO.ABSENT": "Ausente",
  "RECORRIDO.ESTADO.EQUIVALENCE": "Por equivalencia",
  "RECORRIDO.ESTADO.UNKNOWN": "Sin leer",

  // ── El perfil del recorrido · ADR-107 ───────────────────────────────────────
  // ⚠️ Las hipótesis se redactan como lo que son: «nos contaste», «figura en tu
  // analítico». Nunca una etiqueta sobre la persona ni una causa que nadie afirmó.
  "PERFIL.TITULO": "Unas preguntas sobre tu recorrido",
  "PERFIL.SUBCOPY": "Son opcionales y privadas. Podés saltear cualquiera: no cambia nada de lo que ves en Achieve.",
  "PERFIL.SIN_PREGUNTAS": "Con tu analítico no tenemos preguntas para hacerte por ahora.",
  "PERFIL.PREGUNTA.MATERIA_ACTUAL": "Ya cursaste o rendiste {materias} antes. ¿Qué te gustaría que fuera distinto esta vez?",
  "PERFIL.PREGUNTA.RECUPERACION": "En {materias} aparece un primer resultado sin aprobar y después una aprobación. ¿Qué cambió entre esos dos momentos?",
  "PERFIL.PREGUNTA.PERSISTENCIA": "Volviste a intentar {materias} hasta aprobarla. ¿Qué fue lo que más te ayudó a seguir?",
  "PERFIL.PREGUNTA.CAMBIO_DE_PERIODO": "En {anio} aparecen menos materias aprobadas que en otros años. ¿Había algo particular en ese momento?",
  "PERFIL.PREGUNTA.FORTALEZA": "En {materias} tuviste tus mejores notas. ¿Qué sentís que te ayudó?",
  "PERFIL.PREGUNTA.CALIBRACION": "¿En cuáles de estas materias sentís que la nota representa lo que sabías?",
  "PERFIL.OPCION.EMPEZAR_ANTES": "Empezar a estudiar antes",
  "PERFIL.OPCION.MAS_PRACTICA": "Practicar más",
  "PERFIL.OPCION.PEDIR_AYUDA_ANTES": "Pedir ayuda más temprano",
  "PERFIL.OPCION.ORGANIZAR_TIEMPO": "Organizar mejor el tiempo",
  "PERFIL.OPCION.OTRO": "Otra cosa",
  "PERFIL.OPCION.CAMBIE_METODO": "Cambié mi forma de estudiar",
  "PERFIL.OPCION.MAS_TIEMPO": "Le dediqué más tiempo",
  "PERFIL.OPCION.BUSQUE_AYUDA": "Busqué ayuda",
  "PERFIL.OPCION.OTRA_CATEDRA": "Cambié de profesor o cátedra",
  "PERFIL.OPCION.SITUACION_DISTINTA": "Mi situación personal era diferente",
  "PERFIL.OPCION.OTRA_MODALIDAD": "Cambió la modalidad del examen",
  "PERFIL.OPCION.EXAMEN_FAVORABLE": "El segundo examen me resultó más favorable",
  "PERFIL.OPCION.TERMINAR_LA_CARRERA": "Quería avanzar en la carrera",
  "PERFIL.OPCION.APOYO_DE_OTROS": "El apoyo de otras personas",
  "PERFIL.OPCION.CAMBIE_ESTRATEGIA": "Cambiar de estrategia",
  "PERFIL.OPCION.ME_INTERESABA": "Me interesaba la materia",
  "PERFIL.OPCION.TRABAJO": "Trabajo",
  "PERFIL.OPCION.SALUD": "Salud",
  "PERFIL.OPCION.FAMILIA": "Familia",
  "PERFIL.OPCION.MUCHAS_MATERIAS": "Muchas materias a la vez",
  "PERFIL.OPCION.CAMBIO_DE_CARRERA": "Un cambio de carrera o de plan",
  "PERFIL.OPCION.PRACTICA_FRECUENTE": "Practicar seguido",
  "PERFIL.OPCION.ME_GUSTABA": "Me gustaban los temas",
  "PERFIL.OPCION.BUENA_EXPLICACION": "Las explicaciones me sirvieron",
  "PERFIL.OPCION.ESTUDIAR_CON_OTROS": "Estudiar con otras personas",
  "PERFIL.OPCION.TIEMPO_SUFICIENTE": "Tener tiempo suficiente",
  "PERFIL.OPCION.NINGUNA": "En ninguna",
  "PERFIL.TEXTO_LIBRE": "Si querés, contalo con tus palabras (opcional)",
  "PERFIL.RESPONDER": "Guardar respuesta",
  "PERFIL.NO_ESTOY_SEGURO": "No estoy seguro",
  "PERFIL.PREFIERO_NO": "Prefiero no responder",
  "PERFIL.SALTEAR": "Saltear",
  "PERFIL.CONTESTADA.ANSWERED": "Respondida",
  "PERFIL.CONTESTADA.UNSURE": "Marcaste «no estoy seguro»",
  "PERFIL.CONTESTADA.PREFER_NOT_TO_SAY": "Preferiste no responder",
  "PERFIL.CONTESTADA.SKIPPED": "La salteaste",
  "PERFIL.CAMBIAR": "Cambiar respuesta",
  "PERFIL.ENTENDIMOS": "Esto es lo que entendimos hasta ahora",
  "PERFIL.AJUSTE": "Lo vamos a ir ajustando con lo que hagas en Achieve.",
  "PERFIL.NO_ME_REPRESENTA": "Esto no me representa",
  "PERFIL.RECHAZADA": "Lo marcaste como que no te representa.",
  "PERFIL.HECHO.RECUPERACION": "En tu analítico, {materias} figura aprobada después de un primer resultado sin aprobar.",
  "PERFIL.HECHO.PERSISTENCIA": "En tu analítico, volviste a intentar {materias} hasta aprobarla.",
  "PERFIL.HECHO.FORTALEZA": "En tu analítico, tus mejores notas están en {materias}.",
  "PERFIL.CALIBRACION_SI": "Nos dijiste que en {materias} la nota representa lo que sabías.",
  "PERFIL.CALIBRACION_NINGUNA": "Nos dijiste que en {materias} la nota no representa lo que sabías.",
  "PERFIL.MATERIA_ACTUAL.EMPEZAR_ANTES": "Nos contaste que esta vez, en {materias}, querés empezar a estudiar antes.",
  "PERFIL.MATERIA_ACTUAL.MAS_PRACTICA": "Nos contaste que esta vez, en {materias}, querés practicar más.",
  "PERFIL.MATERIA_ACTUAL.PEDIR_AYUDA_ANTES": "Nos contaste que esta vez, en {materias}, querés pedir ayuda más temprano.",
  "PERFIL.MATERIA_ACTUAL.ORGANIZAR_TIEMPO": "Nos contaste que esta vez, en {materias}, querés organizar mejor el tiempo.",
  "PERFIL.RECUPERACION.CAMBIE_METODO": "Nos contaste que en {materias} cambiar tu forma de estudiar te ayudó a aprobar.",
  "PERFIL.RECUPERACION.MAS_TIEMPO": "Nos contaste que en {materias} dedicarle más tiempo te ayudó a aprobar.",
  "PERFIL.RECUPERACION.BUSQUE_AYUDA": "Nos contaste que en {materias} buscar ayuda te ayudó a aprobar.",
  "PERFIL.RECUPERACION.OTRA_CATEDRA": "Nos contaste que en {materias} cambiar de profesor o cátedra influyó.",
  "PERFIL.RECUPERACION.SITUACION_DISTINTA": "Nos contaste que en el primer intento de {materias} tu situación personal era distinta.",
  "PERFIL.RECUPERACION.OTRA_MODALIDAD": "Nos contaste que en {materias} la modalidad del examen influyó.",
  "PERFIL.PERSISTENCIA.TERMINAR_LA_CARRERA": "Nos contaste que querer avanzar en la carrera te ayudó a seguir con {materias}.",
  "PERFIL.PERSISTENCIA.APOYO_DE_OTROS": "Nos contaste que el apoyo de otras personas te ayudó a seguir con {materias}.",
  "PERFIL.PERSISTENCIA.CAMBIE_ESTRATEGIA": "Nos contaste que cambiar de estrategia te ayudó a aprobar {materias}.",
  "PERFIL.PERSISTENCIA.ME_INTERESABA": "Nos contaste que {materias} te interesaba, y eso te ayudó a seguir.",
  "PERFIL.CAMBIO_DE_PERIODO.TRABAJO": "Nos contaste que en {anio} el trabajo influyó en tu cursado.",
  "PERFIL.CAMBIO_DE_PERIODO.SALUD": "Nos contaste que en {anio} tu salud influyó en tu cursado.",
  "PERFIL.CAMBIO_DE_PERIODO.FAMILIA": "Nos contaste que en {anio} tu familia influyó en tu cursado.",
  "PERFIL.CAMBIO_DE_PERIODO.MUCHAS_MATERIAS": "Nos contaste que en {anio} cursar muchas materias a la vez influyó.",
  "PERFIL.CAMBIO_DE_PERIODO.CAMBIO_DE_CARRERA": "Nos contaste que en {anio} hubo un cambio de carrera o de plan.",
  "PERFIL.FORTALEZA.PRACTICA_FRECUENTE": "Nos contaste que en {materias} practicar seguido te ayudó.",
  "PERFIL.FORTALEZA.ME_GUSTABA": "Nos contaste que en {materias} te gustaban los temas.",
  "PERFIL.FORTALEZA.BUENA_EXPLICACION": "Nos contaste que en {materias} las explicaciones te sirvieron.",
  "PERFIL.FORTALEZA.ESTUDIAR_CON_OTROS": "Nos contaste que en {materias} estudiar con otras personas te ayudó.",
  "PERFIL.FORTALEZA.TIEMPO_SUFICIENTE": "Nos contaste que en {materias} tener tiempo suficiente te ayudó.",
  ...
  "ALTA.CURSADA.CTA": "Guardar y terminar",
  ...
  // ── Los requisitos de cursado, simulados (ADR-108) ───────────────────────
  "REQUISITOS.BOTON": "Requisitos",
  "REQUISITOS.TITULO": "Requisitos de cursado",
  "REQUISITOS.SIMULADO": "Simulado",
  /** Va siempre a la vista: nada de esto lo informó la cátedra. */
  "REQUISITOS.ACLARACION": "Condiciones, notas y asistencia de ejemplo. Achieve todavía no recibe estos datos de la cátedra.",
  "REQUISITOS.PROMOCION": "Promoción",
  "REQUISITOS.REGULAR": "Regular",
  "REQUISITOS.SIN_PROMOCION": "Esta materia no tiene promoción.",
  "REQUISITOS.PIDEN": "Piden",
  "REQUISITOS.VENIS": "Venís",
  "REQUISITOS.ESTADO.CUMPLE": "Cumple",
  "REQUISITOS.ESTADO.AJUSTADO": "Ajustado",
  "REQUISITOS.ESTADO.NO_ALCANZA": "No alcanza",
  "REQUISITOS.ESTADO.SIN_DATOS": "Sin datos",
  "REQUISITOS.PARCIALES": "Notas de los parciales",
  "REQUISITOS.PARCIALES.PIDEN": "{n} o más en cada uno",
  "REQUISITOS.PARCIALES.SIN_RENDIR": "Todavía no rendiste ninguno",
  "REQUISITOS.PARCIALES.FALTA": "Falta rendir: {lista}",
  "REQUISITOS.PARCIALES.DEBAJO": "Debajo de {n}: {lista}",
  "REQUISITOS.TPS": "Trabajos prácticos al día",
  "REQUISITOS.TPS.PIDEN": "{n}% aprobados",
  "REQUISITOS.TPS.VENIS": "{aprobados} de {vencidos} aprobados",
  "REQUISITOS.TPS.SIN_VENCIDOS": "Todavía no venció ninguno",
  "REQUISITOS.TPS.QUEDAN": "Quedan {n} por entregar",
  "REQUISITOS.TPS.NECESITAS": "Necesitás {n} aprobados de {total}",
  "REQUISITOS.ASISTENCIA_PRACTICO": "Asistencia al práctico",
  "REQUISITOS.ASISTENCIA_TEORICO": "Asistencia al teórico",
  "REQUISITOS.ASISTENCIA.PIDEN": "{n}%",
  "REQUISITOS.ASISTENCIA.VENIS": "{n}%",
  "REQUISITOS.ASISTENCIA.SIN_CLASES": "Todavía no se dio ninguna clase",
  "REQUISITOS.ASISTENCIA.QUEDAN": "Quedan {n} clases",
  "REQUISITOS.ASISTENCIA.QUEDA_UNA": "Queda 1 clase",
  "REQUISITOS.ASISTENCIA.NO_QUEDAN": "No quedan clases",
  "REQUISITOS.ASISTENCIA.PODES_FALTAR": "podés faltar a {n} más",
  "REQUISITOS.ASISTENCIA.PODES_FALTAR_UNA": "podés faltar a 1 más",
  "REQUISITOS.ASISTENCIA.NINGUNA_FALTA": "no podés faltar a ninguna",
  "REQUISITOS.ASISTENCIA.NO_LLEGAS": "aunque vayas a todas no llegás al {n}%",
  ...
  // ── Modo Focus · ADR-104 ──────────────────────────────────────────────────
  //
  // ⚠️ **«Tiempo registrado en Focus», nunca «tiempo efectivo de estudio»** (§8):
  // el reloj corrió, no se sabe si se estudió cada segundo. **«Avance», nunca
  // «nota»** (§13). Y ninguna copy presenta una duración como la correcta.
  "FOCUS.TITULO": "Focus",
  "FOCUS.SUBCOPY": "Una sesión de trabajo sobre la acción a la que te comprometiste. El reloj empieza cuando tocás Empezar.",
  "FOCUS.ES_HORA": "Es hora de empezar",
  "FOCUS.TE_COMPROMETISTE": "Te comprometiste para las {hora} · {minutos} min",
  "FOCUS.EMPEZAR": "Empezar",
  "FOCUS.EMPIEZA_LIBRE": "Arranca como cronómetro libre. Si querés, después lo pasás a Pomodoro.",
  "FOCUS.SIN_COMPROMISO": "No tenés un compromiso para empezar ahora",
  "FOCUS.SIN_COMPROMISO_REGLA": "Focus trabaja sobre una acción a la que te comprometiste. En Hoy vas a ver cuándo es hora de empezar.",
  "FOCUS.OTRA_ABIERTA": "Ya tenés una sesión de Focus abierta. Volvé a ella, o terminala y guardala antes de empezar otra.",
  "FOCUS.NO_INICIABLE": "Este compromiso no se puede empezar ahora.",
  "FOCUS.LIBRE": "Cronómetro libre",
  "FOCUS.FOCO_DE": "Foco {n} de {total}",
  "FOCUS.TERMINA_A": "termina {hora}",
  "FOCUS.PAUSAR": "Pausar",
  "FOCUS.ESC_PAUSA": "Esc pausa la sesión",
  "FOCUS.TERMINE": "Terminé · Subir evidencia",
  "FOCUS.PASAR_A_POMODORO": "Pasar a Pomodoro",
  "FOCUS.PAUSADA": "Sesión pausada",
  "FOCUS.PAUSADA_REGLA": "El reloj está quieto. Nada corre hasta que toques Continuar.",
  "FOCUS.REGISTRADO": "Tiempo registrado en Focus",
  "FOCUS.CONTINUAR": "Continuar",
  "FOCUS.MINIMIZAR": "Minimizar",
  "FOCUS.SALIR_Y_GUARDAR": "Salir y guardar",
  "FOCUS.DESCANSO": "Descanso",
  "FOCUS.DESCANSO_CORTO": "Descanso corto",
  "FOCUS.DESCANSO_LARGO": "Descanso largo",
  "FOCUS.DESCANSO_REGLA": "Alejate un momento. Achieve te avisa cuando sea hora de volver.",
  "FOCUS.DESPUES": "Después, foco {n} de {total}",
  "FOCUS.VOLVER_ANTES": "Volver antes",
  "FOCUS.TERMINAR_SESION": "Terminar la sesión",
  "FOCUS.LISTA": "Descanso terminado",
  "FOCUS.LISTA_PREGUNTA": "¿Volvés al foco?",
  "FOCUS.CONTINUAR_ESTUDIANDO": "Continuar estudiando",
  "FOCUS.LISTA_REGLA": "El foco empieza recién cuando tocás Continuar estudiando.",
  "FOCUS.RECUPERACION": "Encontramos una sesión sin cerrar",
  "FOCUS.RECUPERACION_META": "Iniciada a las {inicio} · último registro {latido}",
  "FOCUS.RECUPERACION_REGLA": "No contamos tiempo después del último registro. Elegí qué pasó.",
  "FOCUS.REANUDAR": "Seguí estudiando · Reanudar",
  "FOCUS.TERMINE_AL_CERRAR": "Terminé cuando se cerró",
  "FOCUS.REVISAR": "Revisar sesión",
  "FOCUS.CIERRE_TITULO": "¿Qué avanzaste?",
  "FOCUS.CIERRE_AYUDA": "Opcional. Queda en tu Bitácora junto con el tiempo de la sesión.",
  "FOCUS.CIERRE_PISTA": "Por ejemplo: resolví los ejercicios 4, 5 y 6. Me trabé en residuos.",
  "FOCUS.GUARDAR_SESION": "Guardar sesión",
  "FOCUS.GUARDAR_E_IR": "Guardar e ir a subir evidencia",
  "FOCUS.VOLVER": "Volver",
  "FOCUS.GUARDADA": "Sesión guardada",
  "FOCUS.DE_FOCUS": "{duracion} de Focus",
  "FOCUS.HORARIO": "Horario",
  "FOCUS.ACORDADO": "Acordado",
  "FOCUS.ACORDADO_VALOR": "{hora} · {minutos} min",
  "FOCUS.DEMORA": "Empezaste {n} min después de la hora acordada",
  "FOCUS.DURACION_TOTAL": "Duración total",
  "FOCUS.DESCANSOS": "Descanso",
  "FOCUS.PAUSADO": "Pausado",
  "FOCUS.PAUSAS": "Pausas",
  "FOCUS.BLOQUES": "Bloques",
  "FOCUS.BLOQUE_COMPLETO": "1 completo",
  "FOCUS.BLOQUES_COMPLETOS": "{n} completos",
  "FOCUS.BLOQUE_PARCIAL": "1 parcial",
  "FOCUS.BLOQUES_PARCIALES": "{n} parciales",
  "FOCUS.MODO": "Modo",
  "FOCUS.POMODORO": "Pomodoro",
  "FOCUS.AVANCE": "Avance",
  "FOCUS.NO_DICE": "Una sesión registra tiempo. No dice que la acción esté terminada ni entregada.",
  "FOCUS.PARA_DESPUES": "Para después",
  "FOCUS.PARA_DESPUES_AYUDA": "Anotá lo que te distrae y seguí. Sólo lo ves vos: no va a la Bitácora ni a nadie.",
  "FOCUS.GUARDANDO": "Guardando…",
  "FOCUS.GUARDADO": "Guardado",
  "FOCUS.NO_SE_GUARDO": "No se pudo guardar. Reintentamos solos.",
  "FOCUS.POMODORO_AYUDA": "Bloques de foco con descansos. Lo que ya registraste se conserva. Ninguna duración sirve igual a todos: elegí la que te funcione.",
  "FOCUS.PRESET.CLASICO": "Clásico",
  "FOCUS.PRESET.INTERMEDIO": "Intermedio",
  "FOCUS.PRESET.PROFUNDO": "Profundo",
  "FOCUS.PRESET.PERSONALIZADO": "Personalizado",
  "FOCUS.PRESET_VALOR": "{foco} min · descanso {corto} · largo {largo}",
  "FOCUS.CAMPO.FOCO": "Minutos de foco",
  "FOCUS.CAMPO.CORTO": "Descanso corto",
  "FOCUS.CAMPO.LARGO": "Descanso largo",
  "FOCUS.CAMPO.BLOQUES": "Bloques antes del largo",
  "FOCUS.EMPEZAR_BLOQUE": "Empezar bloque",
  "FOCUS.SONIDO": "Sonido",
  "FOCUS.SONIDO.NINGUNO": "Sin sonido",
  "FOCUS.SONIDO.LLUVIA": "Lluvia",
  "FOCUS.SONIDO.MAR": "Mar",
  "FOCUS.SONIDO.VIENTO": "Viento",
  "FOCUS.SONIDO.CHIMENEA": "Chimenea",
  "FOCUS.SONIDO.MARRON": "Ruido marrón",
  "FOCUS.SONIDO.ROSA": "Ruido rosa",
  "FOCUS.PROBAR": "Probar",
  "FOCUS.VOLUMEN": "Volumen",
  "FOCUS.SILENCIAR": "Silenciar",
  "FOCUS.QUITAR_SILENCIO": "Activar sonido",
  "FOCUS.VER_BITACORA": "Ver en la Bitácora",
  "FOCUS.ERROR": "No se pudo completar. Probá de nuevo.",
  "FOCUS.CAMBIO": "La sesión cambió mientras tanto. Ya ves cómo está ahora.",
  "COMPROMISO.CHIP.ES_HORA": "Es hora de empezar",
  // ── Plan vivo en el Calendario — ADR-110 ────────────────────────────────────
  "PLAN_VIVO.TITULO": "La semana de tu plan",
  "PLAN_VIVO.SUBCOPY": "Achieve propone dónde entra tu trabajo según tu disponibilidad, tus clases y tus evaluaciones. Podés moverlo, fijarlo o armarlo vos. Una propuesta no es un compromiso.",
  "PLAN_VIVO.EFIMERO": "Lo que movés, fijás o simulás se pierde al recargar la página. Se guardan la disponibilidad y los compromisos.",
  "PLAN_VIVO.COLA": "Trabajo por ubicar",
  "PLAN_VIVO.COLA_AUTO": "Trabajo que todavía no entra",
  "PLAN_VIVO.COLA_AUTO_VACIA": "Tu trabajo pendiente ya tiene lugar esta semana.",
  "PLAN_VIVO.ENTRARIAN": "Entrarían en tu plan",
  "PLAN_VIVO.NO_ENTRAN": "No entran todavía",
  "PLAN_VIVO.RETENIDAS": "Las sacaste del calendario",
  "PLAN_VIVO.BADGE_ENTRA": "Entra",
  "PLAN_VIVO.BADGE_NO_ENTRA": "No entra todavía",
  "PLAN_VIVO.MARGEN": "Margen disponible",
  "PLAN_VIVO.CANDIDATO": "Propuesta de Achieve · todavía no es una acción",
  "PLAN_VIVO.ACCION": "Tu acción de esta materia",
  "PLAN_VIVO.PROPUESTA": "Propuesta",
  "PLAN_VIVO.ELEGIDA": "Ubicada por vos",
  "PLAN_VIVO.FIJADA": "Fijada",
  "PLAN_VIVO.NO_ES_COMPROMISO": "Todavía no es un compromiso.",
  "PLAN_VIVO.POR_QUE": "¿Por qué?",
  "PLAN_VIVO.FIJAR": "Fijar",
  "PLAN_VIVO.DESFIJAR": "Desfijar",
  "PLAN_VIVO.DEVOLVER": "Devolver a la lista",
  "PLAN_VIVO.ELEGIR_HORARIO": "Elegir horario",
  "PLAN_VIVO.COMPROMETERME": "Comprometerme",
  "PLAN_VIVO.SIMULAR_HECHA": "Simular como realizada",
  "PLAN_VIVO.AUTOMATICO": "Automático",
  "PLAN_VIVO.MANUAL": "Manual",
  "PLAN_VIVO.GUIADO": "Guiado",
  "PLAN_VIVO.LIBRE": "Libre",
  "PLAN_VIVO.RECONSTRUIR": "Volver a la propuesta de Achieve",
  "PLAN_VIVO.VACIAR": "Vaciar organización",
  "PLAN_VIVO.AGREGAR_DISPONIBILIDAD": "Agregar disponibilidad",
  "PLAN_VIVO.TERMINAR_DISPONIBILIDAD": "Listo",
  "PLAN_VIVO.AYUDA_DISPONIBILIDAD": "Arrastrá sobre un horario vacío para marcar cuándo podés estudiar. Tener disponibilidad no es comprometerte.",
  "PLAN_VIVO.QUITAR_FRANJA": "Quitar esta franja",
  "PLAN_VIVO.GUARDAR_DISPONIBILIDAD": "Guardar disponibilidad",
  "PLAN_VIVO.DISPONIBILIDAD_SIN_GUARDAR": "Cambiaste tu disponibilidad. Se guarda para todas las semanas.",
  "PLAN_VIVO.DISPONIBILIDAD_GUARDADA": "Disponibilidad guardada.",
  "PLAN_VIVO.DESHACER": "Deshacer",
  "PLAN_VIVO.REHACER": "Rehacer",
  "PLAN_VIVO.SIMULAR": "Simular cambios",
  "PLAN_VIVO.SIMULANDO": "Estás simulando",
  "PLAN_VIVO.SIMULANDO_AYUDA": "Los cambios no modifican tu plan real.",
  "PLAN_VIVO.DESCARTAR": "Descartar simulación",
  "PLAN_VIVO.SUPUESTA": "Supuesta realizada",
  "PLAN_VIVO.SUPUESTO_AYUDA": "Supone que la hiciste, que la evidencia alcanzó y que se registró el avance. No registra nada.",
  "PLAN_VIVO.METRICA.PENDIENTE": "Trabajo pendiente",
  "PLAN_VIVO.METRICA.RECOMENDADO": "recomendado {min}–{max}",
  "PLAN_VIVO.BACKLOG": "Backlog",
  "PLAN_VIVO.INSPECTOR.COMPROMETIDA": "Comprometida",
  "PLAN_VIVO.INSPECTOR.EN_BACKLOG":
    "En el backlog: esta semana no la pide. Entra si agregás disponibilidad, o arrastrala al calendario.",
  "PLAN_VIVO.INSPECTOR.POR_UBICAR": "Por ubicar.",
  "PLAN_VIVO.INSPECTOR.TERMINARIA": "Terminaría a las",
  "PLAN_VIVO.INSPECTOR.SIN_CHOQUE": "y no se superpone con nada",
  "PLAN_VIVO.INSPECTOR.TEMA": "Tema",
  "PLAN_VIVO.INSPECTOR.EXPLICACION": "Explicación",
  "PLAN_VIVO.INSPECTOR.TIEMPO_APROX": "Tiempo aprox.",
  "PLAN_VIVO.INSPECTOR.SIN_TIEMPO": "sin estimar",
  "PLAN_VIVO.INSPECTOR.EVIDENCIA": "Evidencia esperada",
  "PLAN_VIVO.INSPECTOR.SI_MAXIMO": "Si lleva el máximo",
  "PLAN_VIVO.INSPECTOR.FECHA": "Fecha relacionada",
  "PLAN_VIVO.INSPECTOR.ANTES_DE": "Antes de",
  "PLAN_VIVO.INSPECTOR.NADA": "Nada",
  "PLAN_VIVO.INSPECTOR.DESBLOQUEA": "Qué destraba",
  "PLAN_VIVO.INSPECTOR.POR_QUE_ACA": "Por qué en este horario",
  "PLAN_VIVO.INSPECTOR.ABRIR_MATERIA": "Abrir la materia",
  "PLAN_VIVO.INSPECTOR.ABRIR_CLASE": "Abrir la clase",
  "PLAN_VIVO.INSPECTOR.ABRIR_REGISTRO": "Abrir el registro de la clase",
  "PLAN_VIVO.INSPECTOR.ABRIR_COMPROMISO": "Abrir el compromiso",
  "PLAN_VIVO.INSPECTOR.DOBLE_TOQUE": "Doble toque sobre el bloque para abrirlo. Volvés con «Mi plan», arriba.",
  "PLAN_VIVO.INSPECTOR.FIJO.CLASE": "Horario de la cátedra: no se mueve desde el plan.",
  "PLAN_VIVO.INSPECTOR.FIJO.EVALUACION": "Fecha fija: el plan se acomoda a ella, nunca al revés.",
  "PLAN_VIVO.INSPECTOR.FIJO.COMPROMISO": "Compromiso confirmado. Cambia de horario sólo desde el compromiso.",
  "PLAN_VIVO.INSPECTOR.FIJO.FOCUS": "Sesión de Focus en curso: no se mueve mientras dura.",
  "PLAN_VIVO.INSPECTOR.FIJO.HISTORIA": "Esto ya pasó: queda donde ocurrió y no se mueve.",
  "PLAN_VIVO.INSPECTOR.ESTADO": "Estado",
  "PLAN_VIVO.INSPECTOR.CURSADA": "Ya se dio",
  "PLAN_VIVO.INSPECTOR.PROXIMA": "Próxima",
  "PLAN_VIVO.INSPECTOR.FUENTE": "Fuente",
  "PLAN_VIVO.INSPECTOR.HORARIO_DECLARADO": "Horario declarado",
  "PLAN_VIVO.INSPECTOR.TRABAJO": "Trabajo",
  "PLAN_VIVO.INSPECTOR.PENDIENTE_ANTES": "Pendiente antes",
  "PLAN_VIVO.INSPECTOR.ANTES_DE_ESTA": "Trabajo que tiene que ocurrir antes",
  "PLAN_VIVO.BACKLOG_AYUDA":
    "Trabajo que esta semana no pide. Entra solo si agregás disponibilidad, o arrastralo al calendario si querés hacerlo ya.",
  "PLAN_VIVO.METRICA.PENDIENTE_AYUDA":
    "Tiempo probable del trabajo de esta semana. Achieve recomienda entre 10 y 14 horas; si agregás disponibilidad, entra más. No baja por ubicar ni por comprometerte.",
  "PLAN_VIVO.METRICA.SIN_UBICAR": "Sin ubicar",
  "PLAN_VIVO.METRICA.DISPONIBLE": "Disponibilidad",
  "PLAN_VIVO.METRICA.LIBRE": "libre",
  "PLAN_VIVO.METRICA.SIN_DURACION": "sin tiempo estimado",
  "PLAN_VIVO.PLAN_REAL": "plan real",
  "PLAN_VIVO.CAUSA.SIN_DURACION": "No tiene tiempo estimado: no se puede ubicar.",
  "PLAN_VIVO.CAUSA.DEPENDENCIA": "Espera a",
  "PLAN_VIVO.CAUSA.FECHA_LIMITE": "No queda un horario libre antes de su evaluación.",
  "PLAN_VIVO.CAUSA.FRAGMENTACION": "Hay tiempo libre, pero partido en ratos más cortos que lo que lleva.",
  "PLAN_VIVO.CAUSA.CAPACIDAD": "No queda disponibilidad libre esta semana.",
  "PLAN_VIVO.EXPLICA.FIJADA": "La fijaste en este horario.",
  "PLAN_VIVO.EXPLICA.ELEGIDA": "La ubicaste vos en este horario.",
  "PLAN_VIVO.EXPLICA.PRIMER_HUECO": "Es el primer horario libre de tu disponibilidad donde entra entera.",
  "PLAN_VIVO.EXPLICA.ANTES_DEL_PLAZO": "Es el primer horario libre donde entra entera antes de su evaluación.",
  "PLAN_VIVO.EXPLICA.COMPROMETIDA": "Ya tiene un compromiso: su horario no se mueve desde acá.",
  "PLAN_VIVO.EXPLICA.DEPENDENCIAS": "Hay que trabajar antes",
  "PLAN_VIVO.EXPLICA.RAZONES": "Por qué va en este orden",
  "PLAN_VIVO.EXPLICA.SIGUIENTE": "Lo que sigue en la lista",
  "PLAN_VIVO.EXPLICA.FUENTE": "Sale del mismo orden con el que Achieve elige tu próxima acción. No es una nota ni una predicción.",
  "PLAN_VIVO.CONFLICTO.TITULO": "Este horario no se puede usar",
  "PLAN_VIVO.CONFLICTO.CLASE": "Se superpone con una clase. Las clases no se mueven.",
  "PLAN_VIVO.CONFLICTO.EVALUACION": "Se superpone con una evaluación. Las evaluaciones no se mueven.",
  "PLAN_VIVO.CONFLICTO.COMPROMISO": "Se superpone con un compromiso. Para usar ese horario, primero cambiá el horario del compromiso.",
  "PLAN_VIVO.CONFLICTO.FOCUS": "Se superpone con una sesión de Focus en curso.",
  "PLAN_VIVO.CONFLICTO.HISTORIA": "Ese horario ya tiene algo registrado.",
  "PLAN_VIVO.CONFLICTO.PASADO": "Ese horario ya pasó.",
  "PLAN_VIVO.CONFLICTO.FUERA_DEL_HORIZONTE": "No entra entera dentro de esta semana.",
  "PLAN_VIVO.CONFLICTO.FUERA_DE_DISPONIBILIDAD": "Queda fuera de tu disponibilidad.",
  "PLAN_VIVO.CONFLICTO.PROPUESTA": "Se superpone con otra propuesta.",
  "PLAN_VIVO.CONFLICTO.FIJADA": "Se superpone con algo que fijaste. Desfijalo primero.",
  "PLAN_VIVO.CONFLICTO.SUPERPOSICION":
    "Se superpone más de 15 minutos con otro trabajo que ubicaste. Podés pisar hasta 15 minutos: elegí otro horario, o arrastrala encima de la otra para intercambiarlas.",
  "PLAN_VIVO.CONFLICTO.FECHA_LIMITE": "Terminaría después de su evaluación.",
  "PLAN_VIVO.CONFLICTO.DEPENDENCIA": "Antes hay que trabajar lo que esta unidad necesita, y todavía no tiene lugar antes de este horario.",
  "PLAN_VIVO.CONFLICTO.SIN_DURACION": "No tiene tiempo estimado.",
  "PLAN_VIVO.CONFLICTO.NO_UBICADA": "Las dos tienen que estar en el calendario para intercambiarlas.",
  "PLAN_VIVO.CONFLICTO.ALTERNATIVAS": "Horarios donde sí entra",
  "PLAN_VIVO.CONFLICTO.CAMBIAR_COMPROMISO": "Cambiar horario del compromiso",
  "PLAN_VIVO.CONFIRMAR.TITULO": "¿Asignar igualmente?",
  "PLAN_VIVO.SUPERPUESTA": "{min} min encima",
  "PLAN_VIVO.CONFIRMAR.SIN_DISPONIBILIDAD": "Este horario no está disponible.",
  "PLAN_VIVO.CONFIRMAR.SIN_DISPONIBILIDAD_TEXTO":
    "Si confirmás, se agrega a tu disponibilidad (en verde) para que el trabajo tenga lugar. No es un compromiso.",
  "PLAN_VIVO.CONFIRMAR.SUPERPONE": "Se superpone con otro trabajo tuyo:",
  "PLAN_VIVO.CONFIRMAR.SUPERPONE_REGLA": "Podés pisar hasta 15 minutos. Los dos quedan donde están.",
  "PLAN_VIVO.CONFIRMAR.REUBICA": "Achieve va a mover estas propuestas a otro horario:",
  "PLAN_VIVO.CONFIRMAR.ACEPTAR": "Asignar igualmente",
  "PLAN_VIVO.CONSECUENCIA.TEXTO": "Esto deja de entrar en tu semana:",
  "PLAN_VIVO.CONSECUENCIA.REVISAR": "Ver la que pierde lugar",
  "PLAN_VIVO.INTERCAMBIO.TITULO": "Intercambiar estas dos propuestas",
  "PLAN_VIVO.INTERCAMBIO.TEXTO": "Duran distinto, así que también se mueve:",
  "PLAN_VIVO.INTERCAMBIO.ACEPTAR": "Intercambiar",
  "PLAN_VIVO.INTERCAMBIO.PROHIBIDO": "No se pueden intercambiar",
  "PLAN_VIVO.VACIAR.TITULO": "¿Querés empezar la organización manual desde cero?",
  "PLAN_VIVO.VACIAR.TEXTO": "Se quitarán las propuestas del calendario. Tus compromisos, clases, evaluaciones, disponibilidad y avances se conservarán.",
  "PLAN_VIVO.VACIAR.ACEPTAR": "Vaciar propuestas",
  "PLAN_VIVO.ELEGIR.TITULO": "Elegí un horario",
  "PLAN_VIVO.ELEGIR.VACIO": "No hay un horario libre de tu disponibilidad donde entre entera esta semana.",
  "PLAN_VIVO.COMPROMISO.TITULO": "Comprometerme con esta acción",
  "PLAN_VIVO.COMPROMISO.TEXTO": "Confirmás que la vas a hacer en este horario. Comprometerte no registra avance.",
  "PLAN_VIVO.COMPROMISO.MOTIVO": "Por qué",
  "PLAN_VIVO.COMPROMISO.DURACION": "Tiempo probable",
  "PLAN_VIVO.COMPROMISO.RANGO": "entre {min} y {max} min",
  "PLAN_VIVO.COMPROMISO.LISTO": "Compromiso confirmado. Ya no se mueve desde el plan.",
  "PLAN_VIVO.COMPROMISO.CANDIDATO": "Esta propuesta todavía no es una acción: para comprometerte, esperá a que Achieve te la proponga en Hoy.",
  "PLAN_VIVO.IMPACTO.TITULO": "Impacto académico",
  "PLAN_VIVO.IMPACTO.SUBCOPY": "El recorrido de la materia. Lo que dice «supuesto» es una hipótesis: no es avance registrado ni dice que vayas a aprobar.",
  "PLAN_VIVO.IMPACTO.ACTUAL": "Cómo está",
  "PLAN_VIVO.IMPACTO.SI_LA_HACES": "Si hacés la seleccionada",
  "PLAN_VIVO.IMPACTO.ESCENARIO": "Ver impacto si cumplís este plan",
  "PLAN_VIVO.IMPACTO.SUPUESTO": "Supuesto: criterio alcanzado",
  "PLAN_VIVO.IMPACTO.DESBLOQUEA": "Deja de esperar:",
  "PLAN_VIVO.IMPACTO.PENDIENTE_FINAL": "Seguiría pendiente",
  "PLAN_VIVO.IMPACTO.LLEGAN": "Tienen lugar antes de su evaluación",
  "PLAN_VIVO.IMPACTO.NO_LLEGAN": "Siguen sin lugar antes de su evaluación",
  "PLAN_VIVO.IMPACTO.SIN_GANTT": "Esta materia todavía no tiene unidades cargadas.",
  "PLAN_VIVO.IMPACTO.SIN_MATERIA": "Elegí un trabajo del plan para ver su materia.",
  "PLAN_VIVO.VACIO": "No tenés trabajo pendiente para ubicar esta semana.",
  "PLAN_VIVO.SIN_DISPONIBILIDAD_DECLARADA": "Todavía no marcaste cuándo podés estudiar. Sin disponibilidad, Achieve no ubica nada: agregala con la herramienta de arriba.",
  "PLAN_VIVO.AHORA": "Ahora",
  "PLAN_VIVO.EVALUACION_SIN_HORA": "sin hora",
  "PLAN_VIVO.ERROR": "No se pudo guardar. Probá de nuevo.",
  "PLAN_VIVO.CANCELAR": "Cancelar",
} as const;
