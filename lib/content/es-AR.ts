...
export const copy = {
  ...
  */
  ...
  "PLAN_VIVO.METRICA.PENDIENTE_AYUDA": "Tiempo probable del trabajo que todavía no tiene avance registrado. No baja por ubicar ni por comprometerte.",
  "PLAN_VIVO.METRICA.SIN_UBICAR": "Sin ubicar",
  "PLAN_VIVO.METRICA.NO_ENTRA": "No entra",
  ...
  "PLAN_VIVO.SIN_DISPONIBILIDAD.TITULO": "Este horario todavía no está disponible",
  "PLAN_VIVO.SIN_DISPONIBILIDAD.TEXTO": "Nunca dijiste que podés estudiar a esa hora. Si la agregás, cuenta como disponibilidad; no es un compromiso.",
  "PLAN_VIVO.SIN_DISPONIBILIDAD.ACEPTAR": "Agregar disponibilidad y ubicar",
  "PLAN_VIVO.DESPLAZA.TITULO": "Esto saca otras propuestas de su lugar",
  "PLAN_VIVO.DESPLAZA.ACEPTAR": "Ubicar y reorganizar",
  "PLAN_VIVO.CONSECUENCIA.TITULO": "Otra cosa pierde su lugar",
  "PLAN_VIVO.CONSECUENCIA.TEXTO": "Si la ubicás acá, esto deja de entrar en tu semana:",
  "PLAN_VIVO.CONSECUENCIA.ACEPTAR": "Ubicar igual",
