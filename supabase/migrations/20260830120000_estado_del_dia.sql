-- ─────────────────────────────────────────────────────────────────────────────
-- Achieve Platform · Etapa B2.5 — el estado del día, en una lectura
--
-- `UX01` mira Action, Commitment, Evidence y materias a la vez. Cuatro viajes
-- darían una foto inconsistente entre sí: la Action leída antes de que el reloj
-- venciera el compromiso, y el compromiso después.
--
-- **No decide nada.** La precedencia la resuelve `selectHeroLevel` en
-- `lib/domain/`, la misma que usa el Track A. Esto sólo junta los hechos.
-- ─────────────────────────────────────────────────────────────────────────────
