-- ─────────────────────────────────────────────────────────────────────────────
-- Achieve Platform · Fase B6.21 — `UX02` recibe el horario de cursado
--
-- `VI.2` §1 pone en la pantalla de materia la comparación **cátedra vs. alumno**,
-- y la captura del owner la pedía literal: *«CLASES DE LA SEMANA»*. El dato
-- existe desde `20261001000000_bloque_horario.sql`; acá llega a la superficie.
--
-- La decisión del owner sobre qué hace ese panel fue textual: **«solo mostrar,
-- no agendar»**. Por eso viaja el hecho y nada más — ni una acción, ni un hueco
-- reservado, ni una resta al presupuesto de estudio.
-- ─────────────────────────────────────────────────────────────────────────────
