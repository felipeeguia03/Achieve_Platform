...
| C01-044 | Playbooks, SLA y Human QA del piloto | Product Operations; Intervention/CRM; C01-022/039/046 | OPEN; **no se inventan valores**, y por eso la tabla `playbook` se creó vacía. `circuito_de_senales()` reporta `faltan.playbooks: C01-044` en vez de dar el circuito por cerrado | P1 | P |
